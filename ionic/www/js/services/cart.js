angular.module('starter.services')
    .service('$cart', ['$localStorage', function ($localStorage) {
        ...
        this.addItem = function (item) {
            ...
            for(var index in cart.items){
                ...
                if(itemAux.id == item.id){
                    ...
                    itemAux.subtotal = calculateSubTotal(itemAux); /// altera o registro q ja exite ao invez de deletar e adicionar novamente
                    exists = true;
                    break;
                }
            }
            ...
            $localStorage.setObject(key, cart);  ////sobescreve o cart com o novo registro inserido no novo cart
        };
        ...
        function calculateSubTotal(item) {  //// funcao privada ao declara dessa forma
